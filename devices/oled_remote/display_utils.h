...
// Pass nullptr or "" to hide a label. The separator line and center-button
// box are always drawn when this function is called.
inline void draw_bottom_menu(
    ...
    if (left && left[0] != '\0') {
        it->print(21, 59, font, COLOR_ON, esphome::display::TextAlign::CENTER, left);
    }
    if (center && center[0] != '\0') {
        it->print(64, 59, font, COLOR_ON, esphome::display::TextAlign::CENTER, center);
    }
    if (right && right[0] != '\0') {
        it->print(107, 59, font, COLOR_ON, esphome::display::TextAlign::CENTER, right);
    }
}
